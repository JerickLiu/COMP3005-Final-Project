...
INSERT INTO "Members"
    ("user_id", "first_name", "last_name", "fitness_goals", "exercise", "fitness_achievements", "balance")
    VALUES
    (1, 'Jason', 'Brody', 'Complete a triathlon', 'Crossfit training', 'Deadlift PR 250lbs', 0.00),
    (2, 'Lisa', 'Monaco', 'Climb Mount Everest', 'High altitude training', 'Climbed Everest', 50.99),
...
INSERT INTO "Rooms"
    ...
    VALUES
    ('Yoga Studio', 'Yoga mats'),
    ('Cardio Room', 'Treadmills'),
    ('Outdoor Track', 'Track resurfacing');

INSERT INTO "Sessions"
    ("member_id", "trainer_id", "room_id", "session_date", "session_details")
    VALUES
